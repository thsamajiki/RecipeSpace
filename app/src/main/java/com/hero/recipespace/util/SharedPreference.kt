...
class SharedPreference {
    ...
    companion object {
        ...
        fun getInstance(): SharedPreference {
            return instance ?: synchronized(this) {
                instance ?: SharedPreference().also {
                    instance = it
                }
            }
        }
    ...
    private val COOKIE_NAME = "myapp.pref"


    fun put(context: Context, key: String, value: String) {
        val pref = context.getSharedPreferences(PREF_NAME,
    ...
    fun put(context: Context, key: String, value: HashSet<String>) {
        val pref = context.getSharedPreferences(COOKIE_NAME, Context.MODE_PRIVATE)
        val editor = pref.edit()
    ...
    fun putFirstOpen(context: Context, key: String, value: Boolean) {
        val pref = context.getSharedPreferences("firstopen",
            Context.MODE_PRIVATE)
        val editor = pref.edit()
        editor.putBoolean(key, value)
        editor.apply()
    ...
    fun storeList(context: Context, key: String?, countries: List<*>?) {
        val settings: SharedPreferences
        val editor: SharedPreferences.Editor
        settings = context.getSharedPreferences(PREF_NAME, Context.MODE_PRIVATE)
        editor = settings.edit()
        val gson = Gson()
        val jsonFavorites = gson.toJson(countries)
    ...
    fun addList(context: Context, key: String?, country: String) {
        var favorites: MutableList<String>? = loadList(context, key)
    ...
    fun removeList(context: Context, key: String?, country: String?) {
        val favorites: ArrayList<*>? = loadList(context, key)
        if (favorites != null) {
            favorites.remove(country)
            storeList(context, key, favorites)
        }
