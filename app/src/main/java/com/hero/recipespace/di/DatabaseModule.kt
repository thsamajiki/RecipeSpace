...
object DatabaseModule {
    ...
    @Singleton
    @Provides
    fun provideChatDatabase(@ApplicationContext context: Context) : AppChatDatabase {
    ...
    @Singleton
    @Provides
    fun provideMessageDatabase(@ApplicationContext context: Context) : AppMessageDatabase {
        return Room.databaseBuilder(
            context,
    ...
    @Singleton
    @Provides
    fun provideNoticeDatabase(@ApplicationContext context: Context) : AppNoticeDatabase {
        return Room.databaseBuilder(
            context,
    ...
    @Singleton
    @Provides
    fun provideRateDatabase(@ApplicationContext context: Context) : AppRateDatabase {
        return Room.databaseBuilder(
            context,
    ...
    @Singleton
    @Provides
    fun provideRecipeDatabase(@ApplicationContext context: Context) : AppRecipeDatabase {
        return Room.databaseBuilder(
            context,
    ...
    @Singleton
    @Provides
    fun provideUserDatabase(@ApplicationContext context: Context) : AppUserDatabase {
        return Room.databaseBuilder(
            context,
